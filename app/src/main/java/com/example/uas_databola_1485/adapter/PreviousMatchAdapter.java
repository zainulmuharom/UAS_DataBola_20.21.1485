package com.example.uas_databola_1485.adapter;
...
import com.example.uas_databola_1485.DetailActivity;
import com.example.uas_databola_1485.R;
import com.example.uas_databola_1485.api.ApiService;
...
public class PreviousMatchAdapter extends RecyclerView.Adapter<PreviousMatchAdapter.ViewHolder>{

    private List<EventsItem> listEvents;

    public PreviousMatchAdapter(List<EventsItem> listEvents) {
